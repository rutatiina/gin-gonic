...
import (
	...
	Model_model_name_ "wese/_module_template_/models"
...
func List(c *gin.Context) {
	var models []Model_model_name_.ModelName
	// db.Find(&users)
...
func Show(c *gin.Context) {
	// Get model if exist
	var model Model_model_name_.ModelName
...
func Store(c *gin.Context) {
	/*
		...
		// Create book
		book := Model_model_name_.User{Title: input.Title, Author: input.Author}
	...
	*/
	...
	// Validate input
	var input Model_model_name_.ModelNameNew
	if err := c.ShouldBindBodyWith(&input, binding.JSON); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	var webUser Model_model_name_.ModelName
...
func Update(c *gin.Context) {
	...
	// Validate input
	var input Model_model_name_.ModelNameUpdate
	if err := c.ShouldBindJSON(&input); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
