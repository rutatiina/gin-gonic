...
func ControllerNameOthers(c *gin.Context) {
...
// GET /books
// Find all books
func ControllerNameList(c *gin.Context) {
...
// GET /books/:id
// Find a book
func ControllerNameShow(c *gin.Context) {
	// Get model if exist
...
// POST /books
// Create new book
func ControllerNameStore(c *gin.Context) {
	/*
		// Validate input
		var input UserNew
	...
	*/
	...
	// Validate input
	var input models.ModelNameNew
	if err := c.ShouldBindBodyWith(&input, binding.JSON); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	var webUser models.ModelName
...
// PATCH /books/:id
// Update
func ControllerNameUpdate(c *gin.Context) {
	// Get model if exist
	var model models.ModelName
	if err := services.DB.Where("id = ?", c.Param("id")).First(&model).Error; err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Record not found!"})
	...
	// Validate input
	var input models.ModelNameUpdate
	if err := c.ShouldBindJSON(&input); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// DELETE /books/:id
// Delete a book
func ControllerNameDestroy(c *gin.Context) {
	// Get model if exist
	var model models.ModelName
	if err := services.DB.Where("id = ?", c.Param("id")).First(&model).Error; err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Record not found!"})
...
func ControllerNameVoidDestroyed(c *gin.Context) {
	// Get model if exist
	var model models.ModelName
